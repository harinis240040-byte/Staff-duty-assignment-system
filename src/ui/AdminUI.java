...
public class AdminUI extends JFrame { 
    ...
    public AdminUI() { 
        ...
        add(shiftBox); add(new JLabel("Duty Date (YYYY-MM-DD):")); 
        ...
        assignButton.addActionListener(new ActionListener() { 
            public void actionPerformed(ActionEvent e) { 
                try { 
                    ...
                    String data = nameField.getText() + "," + deptField.getText() + "," + shiftBox.getSelectedItem() + "," + dateField.getText(); out.println(data); 
                    ...
                    socket.close(); } 
                        ...
                        JOptionPane.showMessageDialog(null, "⚠️ Error connecting to server.");
                         ex.printStackTrace(); } } }); setVisible(true); } 
